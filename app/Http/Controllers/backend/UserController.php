...
class UserController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.users.create', compact('roles', 'title'));
    }
    ...
    public function show(User $user)
    {
        $title = "User Details";
        $roles = Role::pluck('name', 'id');
        return view('backend.users.show', compact('user','title', 'roles'));
    }
    ...
    {
        $title = 'Edit Profile';
        return view('backend.users.profile', compact('title','user'));
    }
